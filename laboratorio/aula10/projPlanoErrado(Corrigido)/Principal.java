...
public class Principal {
	...
	public static void main(String[] args) {
		...
		plano.adicionarAula(a5);//a5 = projeto
		plano.adicionarProvaSurpresa();
//System.out.println("ANTES DE IMPRIMIR O PLANO");
		plano.imprimirPlano();
	//	System.out.println("DEPOIS DE IMPRIMIR O PLANO");
		...
		System.out.println("Deu erro veiz\n" + e);
}
}}
